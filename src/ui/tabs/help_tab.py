            ...
            sections_data = [
                ...
                (
                    ...
                    [
                        ...
                        (
                            _("help.subtitles.backup_management"),
                            [
                                "• 支持环境变量配置备份",
                                "• 自动记录备份创建时间",
                                "• 可查看备份文件详情",
                ...
                (
                    ...
                    [
                        ...
                        (
                            _("help.subtitles.backup_management"),
                            [
                                "• Supports environment variable configuration backup",
                                "• Automatically records backup creation time",
                                "• Can view backup file details",
                                "• Supports one-click backup restoration",
                                "• Can delete unnecessary backups",
                                "• Automatic backup file naming",
                                "• Validates configuration before backup",
                                "• Checks compatibility during restoration",
                            ],
                        ),
                    ],
                ),
