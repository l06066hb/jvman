...
def get_icon_path(icon_name):
    ...
    base_paths.extend([
        os.path.join(project_root, 'resources', 'icons'),  # Main project resources directory
        os.path.join(current_dir, '..', '..', '..', 'resources', 'icons'),  # Relative path
        os.path.join(os.path.dirname(sys.executable), 'resources', 'icons'),  # Executable directory
    ])
...
class QuickNavTrigger(QFrame):
    def __init__(self, parent=None):
        ...
        icon_layout = QHBoxLayout(icon_container)  # Use horizontal layout to ensure left-right centering
...
class HelpTab(QWidget):
    ...
    def setup_navigation(self):
        ...
        for key, icon_name in sections_data:
            ...
            nav_btn.clicked.connect(lambda checked, btn=nav_btn: self.scroll_to_section(btn.property("section_key")))
    ...
    def _update_help_content(self):
        ...
        if i18n_manager.get_current_language() == "zh_CN":
            sections_data = [
                (_("help.sections.jdk_vendors"), "java.png", [
            ("Oracle JDK", [
                "• Oracle 官方发行版，提供商业支持",
                "• 包含商业特性和专有功能",
                        "• 下载需要 Oracle 账号",
            ...
            ("Amazon Corretto", [
                ...
                (_("help.sections.version_types"), "java-version.png", [
                ...
                (_("help.sections.platform_support"), "platform.png", [
            ("Windows", [
                "• 使用符号链接进行版本切换",
                "• 需要管理员权限修改系统环境变量",
            ...
            ("Linux", [
                ...
                (_("help.sections.feature_usage"), "feature.png", [
                ...
                (_("help.sections.env_management"), "env.png", [
                ...
                (_("help.sections.usage_tips"), "tips.png", [
                ...
                (_("help.sections.ide.title"), "ide.png", [
                    ...
                    (_("ide.benefits.title"), [
                        ...
                        *[f"  - {point}" for point in _('ide.benefits.env_points')],
                        f"• {_('ide.benefits.project_title')}:",
                        *[f"  - {point}" for point in _('ide.benefits.project_points')],
                        f"• {_('ide.benefits.version_title')}:",
                        *[f"  - {point}" for point in _('ide.benefits.version_points')]
                    ]),
                    (_("ide.practices.title"), [
                        f"• {_('ide.practices.path_title')}:",
                        *[f"  - {point}" for point in _('ide.practices.path_points')],
                        f"• {_('ide.practices.version_title')}:",
                        *[f"  - {point}" for point in _('ide.practices.version_points')],
                        f"• {_('ide.practices.performance_title')}:",
                        *[f"  - {point}" for point in _('ide.practices.performance_points')]
                    ])
                ]),
                (_("help.sections.faq"), "warning.png", [
    ...
    def _apply_syntax_highlighting(self, line):
        ...
        # 关键字高亮
        keywords = ['import', 'from', 'class', 'def', 'return', 'if', 'else', 'for', 'while', 
            ...
            for char in special_chars:
                if char in word:
                    ...
                    for i, part in enumerate(parts):
                        ...
                        if i < len(parts) - 1:
                            new_parts.append(f'<span style="color: #94A3B8;">{char}</span>')
                    word = ''.join(new_parts)
                    break
            else:
        ...
        if '.' in word:
            ...
            for i, part in enumerate(parts):
                if i == 0:
                    ...
                    highlighted_parts.append(f'<span style="color: #60A5FA;">{part}</span>')
    ...
    def add_help_section(self, parent_layout, title, icon_name, items):
        ...
        for item_title, item_list in items:
            ...
            # 确保子标题被翻译
            item_title_label = QLabel(_(item_title) if isinstance(item_title, str) else item_title)
